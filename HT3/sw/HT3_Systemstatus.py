...
logfilename="ht_systemstatus.log"
      #### reconfiguration has to be done in configuration-file ####
HT3_Systemstatus=ht3_worker.ht3_cworker(configurationfilename, hexdump_window=False, logfilename_in=logfilename)
HT3_Systemstatus.run()
